...
print("BrickVerse is cool: " .. tostring(isBrickVerseCool)) --> BrickVerse is cool: true</code></pre> |
...
print(assert(tonumber("brickverse"))) --> Error: assertion failed</code></pre> |
...
assert(product == 360, "Oh dear, multiplication is broken")-- The line above does nothing, because 90 times 4 is 360</code></pre> |
